<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceCreated.aspx.cs" Inherits="EAP_Supplier_Votech.Web.Admin.Lester.InvoiceCreated" %>
            ...
            <div class="container mb-5 mt-2 border shadow pl-5 pr-5 pb-5 pt-3">
                    ...
                    <div class="col-md-6 ">
                        <div class="float-right">
                            ...
                            <p>
                                ...
                                <asp:Label ID="lbl_InvoiceNum" runat="server" Text=""></asp:Label>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>
                                    ...
                                    <p>
                                        <span class="font-weight-bold">Address</span> :<asp:Label ID="lbl_CompanyAddress" runat="server" Text=""></asp:Label>
                                        <br>
                                    </p>
                                    <p>
                                        <span class="font-weight-bold">Email</span> &nbsp;&nbsp;&nbsp;&nbsp;:
                                        <asp:Label ID="lbl_CompanyEmail" runat="server" Text=""></asp:Label>
                                    </p>
                                    <p>
                                        <span class="font-weight-bold">Contact</span> :
                                        <asp:Label ID="lbl_Companycontact" runat="server" Text=""></asp:Label>
                                    </p>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gv_InvoiceOrderItem" runat="server" DataKeyNames="OI_ID" CssClass="table table-striped table-light table-condensed table-responsive border-0" AutoGenerateColumns="False" ShowFooter="False">
                            <Columns>
                    ...
                    <div class="col-md-12">
                        <div class="text-center">
                            <footer class="blockquote-footer">
                                If you have any enquires or feedback on this Invoice,
                        please contact
                                <br>
                                <cite title="Source Title">Votech.EAP@gmail.com or at (+65) 6874 5852
                                </cite>
                            </footer>
                        </div>
                    </div>
